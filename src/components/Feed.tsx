...
// const text =
//   "This is an archive of everything from early sketches to finished products.";

const Feed = () => {
  return (
    <div className="relative isolate px-6 lg:px-8 border-neutral-200 ">
      <div className="mx-auto  py-20 sm:py-48 lg:py-10 ">
        <motion.div
          initial="hidden"
