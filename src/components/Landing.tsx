...
const Landing = () => {
  return (
    <div className="relative isolate px-6  lg:px-8">
      ...
      <div className="mx-auto max-w-4xl py-20 sm:py-48 lg:py-40">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center"></div>
        <div className="text-center">
          <h1 className="text-4xl font-lite tracking-tight text-white sm:text-6xl pb-4 ">
            Passionate React Developer
          </h1>
          <p className="text-sm font-lite tracking-tight text-white sm:text-4xl ">
            Creating Dynamic Web Experiences
          </p>

          <p className="mt-6 text-lg leading-7 tracking-tight text-white">
