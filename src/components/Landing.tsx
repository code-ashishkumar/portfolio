...
const Landing = () => {
  ...
  return (
    <div className="relative isolate px-6 lg:px-8">
      <div className="mx-auto max-w-7xl py-40 sm:py-48 lg:py-40 ">
        <div className="text-center">
          ...
          <motion.h1
            className="text-7xl font-lite tracking-tight sm:text-7xl pb-2"
          ...
          <motion.h1
            className="mt-4 mx-auto max-w-4xl text-lite text-lg leading-7 tracking-tight"
